...
def Sala():
    ...
    Btn_LuzSala = Button(ventana_3, text = "Luz Sala", width = 5 , height = 2, command = lambda:encendido(2)).place(x=30,y=30)
    Btn_PuertaP = Button(ventana_3, text = "Puerta Principal", width = 5 , height = 2, command = lambda:encendido(3)).place(x=100,y=30)
...
def Servos():
    ...
    Btn_Puerta_Principal = Button(ventana_4, text = "Ventilador 1", width = 15 , height = 2, command = lambda:encendido(5)).place(x=31.5,y=15)
    Btn_Garaje = Button(ventana_4, text = "Ventilador 2", width = 15 , height = 2, command = lambda:encendido(6)).place(x=31.5,y=75)

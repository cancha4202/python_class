...
Botoncito_17 = Button(root, text = "^", width = 4 , height = 2, command = lambda:btnClick('**')).place(x=270,y=100)
Botoncito_18 = Button(root, text = "SQR 2", width = 4 , height = 2, command = lambda:btnClick('**(1/2)')).place(x=270,y=150)

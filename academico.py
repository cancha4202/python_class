...
print ("El estudiande" ,persona1," tiene " ,edad1," años")
print ("El estudiande" ,persona2," tiene " ,edad2," años")
print ("El estudiande" ,persona3," tiene " ,edad3," años")
print ("El estudiande" ,persona4," tiene " ,edad4," años")
